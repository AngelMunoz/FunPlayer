...
type MudTextFieldBuilder<'FunBlazorGeneric, 'T when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Clearable")>] member _.Clearable (render: AttrRenderFragment, x: System.Boolean) = render ==> ("Clearable" => x)
    [<CustomOperation("OnClearButtonClick")>] member _.OnClearButtonClick (render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnClearButtonClick", fn)
    [<CustomOperation("Mask")>] member _.Mask (render: AttrRenderFragment, x: MudBlazor.IMask) = render ==> ("Mask" => x)
...
type MudSelectBuilder<'FunBlazorGeneric, 'T when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnOpen")>] member _.OnOpen (render: AttrRenderFragment, fn) = render ==> html.callback<unit>("OnOpen", fn)
    [<CustomOperation("OnClose")>] member _.OnClose (render: AttrRenderFragment, fn) = render ==> html.callback<unit>("OnClose", fn)
    [<CustomOperation("PopoverClass")>] member _.PopoverClass (render: AttrRenderFragment, x: System.String) = render ==> ("PopoverClass" => x)
    [<CustomOperation("Dense")>] member _.Dense (render: AttrRenderFragment, x: System.Boolean) = render ==> ("Dense" => x)
    [<CustomOperation("OpenIcon")>] member _.OpenIcon (render: AttrRenderFragment, x: System.String) = render ==> ("OpenIcon" => x)
    [<CustomOperation("CloseIcon")>] member _.CloseIcon (render: AttrRenderFragment, x: System.String) = render ==> ("CloseIcon" => x)
...
type MudPickerBuilder<'FunBlazorGeneric, 'T when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("PickerActions")>] member _.PickerActions (render: AttrRenderFragment, fn: MudBlazor.MudPicker<'T> -> NodeRenderFragment) = render ==> html.renderFragment("PickerActions", fn)
    [<CustomOperation("Margin")>] member _.Margin (render: AttrRenderFragment, x: MudBlazor.Margin) = render ==> ("Margin" => x)
...
type MudDropContainerBuilder<'FunBlazorGeneric, 'T when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Items")>] member _.Items (render: AttrRenderFragment, x: System.Collections.Generic.IEnumerable<'T>) = render ==> ("Items" => x)
    [<CustomOperation("ItemRenderer")>] member _.ItemRenderer (render: AttrRenderFragment, fn: 'T -> NodeRenderFragment) = render ==> html.renderFragment("ItemRenderer", fn)
    [<CustomOperation("ItemsSelector")>] member _.ItemsSelector (render: AttrRenderFragment, fn) = render ==> ("ItemsSelector" => (System.Func<'T, System.String, System.Boolean>fn))
    [<CustomOperation("ItemDropped")>] member _.ItemDropped (render: AttrRenderFragment, fn) = render ==> html.callback<MudBlazor.MudItemDropInfo<'T>>("ItemDropped", fn)
    [<CustomOperation("CanDrop")>] member _.CanDrop (render: AttrRenderFragment, fn) = render ==> ("CanDrop" => (System.Func<'T, System.String, System.Boolean>fn))
    [<CustomOperation("CanDropClass")>] member _.CanDropClass (render: AttrRenderFragment, x: System.String) = render ==> ("CanDropClass" => x)
    [<CustomOperation("NoDropClass")>] member _.NoDropClass (render: AttrRenderFragment, x: System.String) = render ==> ("NoDropClass" => x)
    [<CustomOperation("ApplyDropClassesOnDragStarted")>] member _.ApplyDropClassesOnDragStarted (render: AttrRenderFragment, x: System.Boolean) = render ==> ("ApplyDropClassesOnDragStarted" => x)
    [<CustomOperation("ItemIsDisabled")>] member _.ItemIsDisabled (render: AttrRenderFragment, fn) = render ==> ("ItemIsDisabled" => (System.Func<'T, System.Boolean>fn))
    [<CustomOperation("DisabledClass")>] member _.DisabledClass (render: AttrRenderFragment, x: System.String) = render ==> ("DisabledClass" => x)
    [<CustomOperation("DraggingClass")>] member _.DraggingClass (render: AttrRenderFragment, x: System.String) = render ==> ("DraggingClass" => x)
    [<CustomOperation("ItemDraggingClass")>] member _.ItemDraggingClass (render: AttrRenderFragment, x: System.String) = render ==> ("ItemDraggingClass" => x)
...
type MudDropZoneBuilder<'FunBlazorGeneric, 'T when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Identifier")>] member _.Identifier (render: AttrRenderFragment, x: System.String) = render ==> ("Identifier" => x)
    [<CustomOperation("ItemRenderer")>] member _.ItemRenderer (render: AttrRenderFragment, fn: 'T -> NodeRenderFragment) = render ==> html.renderFragment("ItemRenderer", fn)
    [<CustomOperation("ItemsSelector")>] member _.ItemsSelector (render: AttrRenderFragment, fn) = render ==> ("ItemsSelector" => (System.Func<'T, System.Boolean>fn))
    [<CustomOperation("CanDrop")>] member _.CanDrop (render: AttrRenderFragment, fn) = render ==> ("CanDrop" => (System.Func<'T, System.Boolean>fn))
    [<CustomOperation("CanDropClass")>] member _.CanDropClass (render: AttrRenderFragment, x: System.String) = render ==> ("CanDropClass" => x)
    [<CustomOperation("NoDropClass")>] member _.NoDropClass (render: AttrRenderFragment, x: System.String) = render ==> ("NoDropClass" => x)
    [<CustomOperation("ApplyDropClassesOnDragStarted")>] member _.ApplyDropClassesOnDragStarted (render: AttrRenderFragment, x: System.Nullable<System.Boolean>) = render ==> ("ApplyDropClassesOnDragStarted" => x)
    [<CustomOperation("ItemIsDisabled")>] member _.ItemIsDisabled (render: AttrRenderFragment, fn) = render ==> ("ItemIsDisabled" => (System.Func<'T, System.Boolean>fn))
    [<CustomOperation("DisabledClass")>] member _.DisabledClass (render: AttrRenderFragment, x: System.String) = render ==> ("DisabledClass" => x)
    [<CustomOperation("DraggingClass")>] member _.DraggingClass (render: AttrRenderFragment, x: System.String) = render ==> ("DraggingClass" => x)
    [<CustomOperation("ItemDraggingClass")>] member _.ItemDraggingClass (render: AttrRenderFragment, x: System.String) = render ==> ("ItemDraggingClass" => x)
...
type MudDynamicDropItemBuilder<'FunBlazorGeneric, 'T when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ZoneIdentifier")>] member _.ZoneIdentifier (render: AttrRenderFragment, x: System.String) = render ==> ("ZoneIdentifier" => x)
    [<CustomOperation("Item")>] member _.Item (render: AttrRenderFragment, x: 'T) = render ==> ("Item" => x)
    [<CustomOperation("DraggingClass")>] member _.DraggingClass (render: AttrRenderFragment, x: System.String) = render ==> ("DraggingClass" => x)
    [<CustomOperation("OnDragStarted")>] member _.OnDragStarted (render: AttrRenderFragment, fn) = render ==> html.callback<'T>("OnDragStarted", fn)
    [<CustomOperation("OnDragEnded")>] member _.OnDragEnded (render: AttrRenderFragment, fn) = render ==> html.callback<'T>("OnDragEnded", fn)
    [<CustomOperation("Disabled")>] member _.Disabled (render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    [<CustomOperation("DisabledClass")>] member _.DisabledClass (render: AttrRenderFragment, x: System.String) = render ==> ("DisabledClass" => x)
...
type MudImageBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Fluid")>] member _.Fluid (render: AttrRenderFragment, x: System.Boolean) = render ==> ("Fluid" => x)
    [<CustomOperation("Src")>] member _.Src (render: AttrRenderFragment, x: System.String) = render ==> ("Src" => x)
    [<CustomOperation("Alt")>] member _.Alt (render: AttrRenderFragment, x: System.String) = render ==> ("Alt" => x)
    [<CustomOperation("Height")>] member _.Height (render: AttrRenderFragment, x: System.Nullable<System.Int32>) = render ==> ("Height" => x)
    [<CustomOperation("Width")>] member _.Width (render: AttrRenderFragment, x: System.Nullable<System.Int32>) = render ==> ("Width" => x)
    [<CustomOperation("Elevation")>] member _.Elevation (render: AttrRenderFragment, x: System.Int32) = render ==> ("Elevation" => x)
    [<CustomOperation("ObjectFit")>] member _.ObjectFit (render: AttrRenderFragment, x: MudBlazor.ObjectFit) = render ==> ("ObjectFit" => x)
    [<CustomOperation("ObjectPosition")>] member _.ObjectPosition (render: AttrRenderFragment, x: MudBlazor.ObjectPosition) = render ==> ("ObjectPosition" => x)
...
type MudMessageBoxBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("MarkupMessage")>] member _.MarkupMessage (render: AttrRenderFragment, x: Microsoft.AspNetCore.Components.MarkupString) = render ==> ("MarkupMessage" => x)
...
type MudPageContentNavigationBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("HierarchyMapper")>] member _.HierarchyMapper (render: AttrRenderFragment, x: System.Collections.Generic.IDictionary<System.String, System.Int32>) = render ==> ("HierarchyMapper" => x)
    [<CustomOperation("ExpandBehaviour")>] member _.ExpandBehaviour (render: AttrRenderFragment, x: MudBlazor.ContentNavigationExpandBehaviour) = render ==> ("ExpandBehaviour" => x)
