...
type MudTextFieldBuilder<'FunBlazorGeneric, 'T when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Clearable")>] member this.Clearable (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.Boolean) = "Clearable" => x |> this.AddAttr
    [<CustomOperation("OnClearButtonClick")>] member this.OnClearButtonClick (_: FunBlazorBuilder<'FunBlazorGeneric>, fn) = (Bolero.Html.attr.callback<Microsoft.AspNetCore.Components.Web.MouseEventArgs> "OnClearButtonClick" (fun e -> fn e)) |> this.AddAttr
    [<CustomOperation("Mask")>] member this.Mask (_: FunBlazorBuilder<'FunBlazorGeneric>, x: MudBlazor.IMask) = "Mask" => x |> this.AddAttr
...
type MudMaskBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    new (x: string) as this = MudMaskBuilder<'FunBlazorGeneric>() then Bolero.Html.attr.fragment "ChildContent" (x |> html.text) |> this.AddAttr |> ignore
    new (x: Bolero.Node list) as this = MudMaskBuilder<'FunBlazorGeneric>() then Bolero.Html.attr.fragment "ChildContent" (x |> html.fragment) |> this.AddAttr |> ignore
    static member create (x: string) = MudMaskBuilder<'FunBlazorGeneric>(x).CreateNode()
    static member create (x: Bolero.Node list) = MudMaskBuilder<'FunBlazorGeneric>(x).CreateNode()
    [<CustomOperation("Mask")>] member this.Mask (_: FunBlazorBuilder<'FunBlazorGeneric>, x: MudBlazor.IMask) = "Mask" => x |> this.AddAttr
    [<CustomOperation("InputType")>] member this.InputType (_: FunBlazorBuilder<'FunBlazorGeneric>, x: MudBlazor.InputType) = "InputType" => x |> this.AddAttr
    [<CustomOperation("Clearable")>] member this.Clearable (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.Boolean) = "Clearable" => x |> this.AddAttr
    [<CustomOperation("OnClearButtonClick")>] member this.OnClearButtonClick (_: FunBlazorBuilder<'FunBlazorGeneric>, fn) = (Bolero.Html.attr.callback<Microsoft.AspNetCore.Components.Web.MouseEventArgs> "OnClearButtonClick" (fun e -> fn e)) |> this.AddAttr
...
type MudSelectBuilder<'FunBlazorGeneric, 'T when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnOpen")>] member this.OnOpen (_: FunBlazorBuilder<'FunBlazorGeneric>, fn) = attr.callbackOfUnit("OnOpen", fn) |> this.AddAttr
    [<CustomOperation("OnClose")>] member this.OnClose (_: FunBlazorBuilder<'FunBlazorGeneric>, fn) = attr.callbackOfUnit("OnClose", fn) |> this.AddAttr
    [<CustomOperation("PopoverClass")>] member this.PopoverClass (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "PopoverClass" => x |> this.AddAttr
    [<CustomOperation("Dense")>] member this.Dense (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.Boolean) = "Dense" => x |> this.AddAttr
    [<CustomOperation("OpenIcon")>] member this.OpenIcon (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "OpenIcon" => x |> this.AddAttr
    [<CustomOperation("CloseIcon")>] member this.CloseIcon (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "CloseIcon" => x |> this.AddAttr
...
type MudPickerBuilder<'FunBlazorGeneric, 'T when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("PickerActions")>] member this.PickerActions (_: FunBlazorBuilder<'FunBlazorGeneric>, render: MudBlazor.MudPicker<'T> -> Bolero.Node) = Bolero.Html.attr.fragmentWith "PickerActions" (fun x -> render x) |> this.AddAttr
    [<CustomOperation("Margin")>] member this.Margin (_: FunBlazorBuilder<'FunBlazorGeneric>, x: MudBlazor.Margin) = "Margin" => x |> this.AddAttr
...
type MudDropContainerBuilder<'FunBlazorGeneric, 'T when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit MudComponentBaseBuilder<'FunBlazorGeneric>()
    new (x: string) as this = MudDropContainerBuilder<'FunBlazorGeneric, 'T>() then Bolero.Html.attr.fragment "ChildContent" (x |> html.text) |> this.AddAttr |> ignore
    new (x: Bolero.Node list) as this = MudDropContainerBuilder<'FunBlazorGeneric, 'T>() then Bolero.Html.attr.fragment "ChildContent" (x |> html.fragment) |> this.AddAttr |> ignore
    static member create (x: string) = MudDropContainerBuilder<'FunBlazorGeneric, 'T>(x).CreateNode()
    static member create (x: Bolero.Node list) = MudDropContainerBuilder<'FunBlazorGeneric, 'T>(x).CreateNode()
    [<CustomOperation("Items")>] member this.Items (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.Collections.Generic.IEnumerable<'T>) = "Items" => x |> this.AddAttr
    [<CustomOperation("ItemRenderer")>] member this.ItemRenderer (_: FunBlazorBuilder<'FunBlazorGeneric>, render: 'T -> Bolero.Node) = Bolero.Html.attr.fragmentWith "ItemRenderer" (fun x -> render x) |> this.AddAttr
    [<CustomOperation("ItemsSelector")>] member this.ItemsSelector (_: FunBlazorBuilder<'FunBlazorGeneric>, fn) = "ItemsSelector" => (System.Func<'T, System.String, System.Boolean>fn) |> this.AddAttr
    [<CustomOperation("ItemDropped")>] member this.ItemDropped (_: FunBlazorBuilder<'FunBlazorGeneric>, fn) = (Bolero.Html.attr.callback<MudBlazor.MudItemDropInfo<'T>> "ItemDropped" (fun e -> fn e)) |> this.AddAttr
    [<CustomOperation("CanDrop")>] member this.CanDrop (_: FunBlazorBuilder<'FunBlazorGeneric>, fn) = "CanDrop" => (System.Func<'T, System.String, System.Boolean>fn) |> this.AddAttr
    [<CustomOperation("CanDropClass")>] member this.CanDropClass (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "CanDropClass" => x |> this.AddAttr
    [<CustomOperation("NoDropClass")>] member this.NoDropClass (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "NoDropClass" => x |> this.AddAttr
    [<CustomOperation("ApplyDropClassesOnDragStarted")>] member this.ApplyDropClassesOnDragStarted (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.Boolean) = "ApplyDropClassesOnDragStarted" => x |> this.AddAttr
    [<CustomOperation("ItemIsDisabled")>] member this.ItemIsDisabled (_: FunBlazorBuilder<'FunBlazorGeneric>, fn) = "ItemIsDisabled" => (System.Func<'T, System.Boolean>fn) |> this.AddAttr
    [<CustomOperation("DisabledClass")>] member this.DisabledClass (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "DisabledClass" => x |> this.AddAttr
    [<CustomOperation("DraggingClass")>] member this.DraggingClass (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "DraggingClass" => x |> this.AddAttr
    [<CustomOperation("ItemDraggingClass")>] member this.ItemDraggingClass (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "ItemDraggingClass" => x |> this.AddAttr
                

type MudDropZoneBuilder<'FunBlazorGeneric, 'T when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit MudComponentBaseBuilder<'FunBlazorGeneric>()
    new (x: string) as this = MudDropZoneBuilder<'FunBlazorGeneric, 'T>() then Bolero.Html.attr.fragment "ChildContent" (x |> html.text) |> this.AddAttr |> ignore
    new (x: Bolero.Node list) as this = MudDropZoneBuilder<'FunBlazorGeneric, 'T>() then Bolero.Html.attr.fragment "ChildContent" (x |> html.fragment) |> this.AddAttr |> ignore
    static member create (x: string) = MudDropZoneBuilder<'FunBlazorGeneric, 'T>(x).CreateNode()
    static member create (x: Bolero.Node list) = MudDropZoneBuilder<'FunBlazorGeneric, 'T>(x).CreateNode()
    [<CustomOperation("Identifier")>] member this.Identifier (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "Identifier" => x |> this.AddAttr
    [<CustomOperation("ItemRenderer")>] member this.ItemRenderer (_: FunBlazorBuilder<'FunBlazorGeneric>, render: 'T -> Bolero.Node) = Bolero.Html.attr.fragmentWith "ItemRenderer" (fun x -> render x) |> this.AddAttr
    [<CustomOperation("ItemsSelector")>] member this.ItemsSelector (_: FunBlazorBuilder<'FunBlazorGeneric>, fn) = "ItemsSelector" => (System.Func<'T, System.Boolean>fn) |> this.AddAttr
    [<CustomOperation("CanDrop")>] member this.CanDrop (_: FunBlazorBuilder<'FunBlazorGeneric>, fn) = "CanDrop" => (System.Func<'T, System.Boolean>fn) |> this.AddAttr
    [<CustomOperation("CanDropClass")>] member this.CanDropClass (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "CanDropClass" => x |> this.AddAttr
    [<CustomOperation("NoDropClass")>] member this.NoDropClass (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "NoDropClass" => x |> this.AddAttr
    [<CustomOperation("ApplyDropClassesOnDragStarted")>] member this.ApplyDropClassesOnDragStarted (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.Nullable<System.Boolean>) = "ApplyDropClassesOnDragStarted" => x |> this.AddAttr
    [<CustomOperation("ItemIsDisabled")>] member this.ItemIsDisabled (_: FunBlazorBuilder<'FunBlazorGeneric>, fn) = "ItemIsDisabled" => (System.Func<'T, System.Boolean>fn) |> this.AddAttr
    [<CustomOperation("DisabledClass")>] member this.DisabledClass (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "DisabledClass" => x |> this.AddAttr
    [<CustomOperation("DraggingClass")>] member this.DraggingClass (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "DraggingClass" => x |> this.AddAttr
    [<CustomOperation("ItemDraggingClass")>] member this.ItemDraggingClass (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "ItemDraggingClass" => x |> this.AddAttr
...
type MudDynamicDropItemBuilder<'FunBlazorGeneric, 'T when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit MudComponentBaseBuilder<'FunBlazorGeneric>()
    new (x: string) as this = MudDynamicDropItemBuilder<'FunBlazorGeneric, 'T>() then Bolero.Html.attr.fragment "ChildContent" (x |> html.text) |> this.AddAttr |> ignore
    new (x: Bolero.Node list) as this = MudDynamicDropItemBuilder<'FunBlazorGeneric, 'T>() then Bolero.Html.attr.fragment "ChildContent" (x |> html.fragment) |> this.AddAttr |> ignore
    static member create (x: string) = MudDynamicDropItemBuilder<'FunBlazorGeneric, 'T>(x).CreateNode()
    static member create (x: Bolero.Node list) = MudDynamicDropItemBuilder<'FunBlazorGeneric, 'T>(x).CreateNode()
    [<CustomOperation("ZoneIdentifier")>] member this.ZoneIdentifier (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "ZoneIdentifier" => x |> this.AddAttr
    [<CustomOperation("Item")>] member this.Item (_: FunBlazorBuilder<'FunBlazorGeneric>, x: 'T) = "Item" => x |> this.AddAttr
    [<CustomOperation("DraggingClass")>] member this.DraggingClass (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "DraggingClass" => x |> this.AddAttr
    [<CustomOperation("OnDragStarted")>] member this.OnDragStarted (_: FunBlazorBuilder<'FunBlazorGeneric>, fn) = (Bolero.Html.attr.callback<'T> "OnDragStarted" (fun e -> fn e)) |> this.AddAttr
    [<CustomOperation("OnDragEnded")>] member this.OnDragEnded (_: FunBlazorBuilder<'FunBlazorGeneric>, fn) = (Bolero.Html.attr.callback<'T> "OnDragEnded" (fun e -> fn e)) |> this.AddAttr
    [<CustomOperation("Disabled")>] member this.Disabled (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.Boolean) = "Disabled" => x |> this.AddAttr
    [<CustomOperation("DisabledClass")>] member this.DisabledClass (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "DisabledClass" => x |> this.AddAttr
...
type MudImageBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit MudComponentBaseBuilder<'FunBlazorGeneric>()
    static member create () = MudImageBuilder<'FunBlazorGeneric>().CreateNode()
    [<CustomOperation("Fluid")>] member this.Fluid (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.Boolean) = "Fluid" => x |> this.AddAttr
    [<CustomOperation("Src")>] member this.Src (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "Src" => x |> this.AddAttr
    [<CustomOperation("Alt")>] member this.Alt (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.String) = "Alt" => x |> this.AddAttr
    [<CustomOperation("Height")>] member this.Height (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.Nullable<System.Int32>) = "Height" => x |> this.AddAttr
    [<CustomOperation("Width")>] member this.Width (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.Nullable<System.Int32>) = "Width" => x |> this.AddAttr
    [<CustomOperation("Elevation")>] member this.Elevation (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.Int32) = "Elevation" => x |> this.AddAttr
    [<CustomOperation("ObjectFit")>] member this.ObjectFit (_: FunBlazorBuilder<'FunBlazorGeneric>, x: MudBlazor.ObjectFit) = "ObjectFit" => x |> this.AddAttr
    [<CustomOperation("ObjectPosition")>] member this.ObjectPosition (_: FunBlazorBuilder<'FunBlazorGeneric>, x: MudBlazor.ObjectPosition) = "ObjectPosition" => x |> this.AddAttr
...
type MudMessageBoxBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("MarkupMessage")>] member this.MarkupMessage (_: FunBlazorBuilder<'FunBlazorGeneric>, x: Microsoft.AspNetCore.Components.MarkupString) = "MarkupMessage" => x |> this.AddAttr
...
type MudPageContentNavigationBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("HierarchyMapper")>] member this.HierarchyMapper (_: FunBlazorBuilder<'FunBlazorGeneric>, x: System.Collections.Generic.IDictionary<System.String, System.Int32>) = "HierarchyMapper" => x |> this.AddAttr
    [<CustomOperation("ExpandBehaviour")>] member this.ExpandBehaviour (_: FunBlazorBuilder<'FunBlazorGeneric>, x: MudBlazor.ContentNavigationExpandBehaviour) = "ExpandBehaviour" => x |> this.AddAttr
